...
if __name__ == '__main__':
    ...
    print("...", indicators.rsi(14)[-10:])

    # 计算stoch
    print("=" * 25, "计算stoch(9,6)", "=" * 25)
    stoch_list = indicators.stoch(9, 1, 6)
    print("...", [[stoch.k, stoch.d] for stoch in stoch_list[-10:]])

    # 计算stoch_rsi
    print("=" * 25, "计算stoch_rsi(14)", "=" * 25)
    stoch_rsi = indicators.stoch_rsi(14, 5, 3, 3)
    print("...", [[v.k, v.d] for v in stoch_rsi[-10:]])

    # 计算macd
    print("=" * 25, "计算macd(12,26)", "=" * 25)
    macd = indicators.macd(12, 26, 9)
    print("...", [[v.hist, v.macd, v.signal] for v in macd[-10:]])

    # 计算ma(5)
    print("=" * 25, "计算ma(5)", "=" * 25)
    ma = indicators.ma(5)
    print("...", [v for v in ma[-10:]])
    ...
    print("...", [[v.high, v.low] for v in ma[-10:]])
    ...
    print("...", [[v.upper_band, v.lower_band, v.middle_band] for v in macd[-10:]])
